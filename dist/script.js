...
Object(_modules_menu__WEBPACK_IMPORTED_MODULE_1__["default"])(".menu-open-up", ".menu", ".menu__left-col");
Object(_modules_smoothScroll__WEBPACK_IMPORTED_MODULE_0__["default"])(".up-btn");
...
var menu = function menu(triggersSelector, menuSelector, subMenuSelector) {
  var menuOpenUpBtns = document.querySelectorAll(triggersSelector),
  ...
  triggers.forEach(function (btn) {
    ...
    btn.addEventListener("mouseleave", function (e) {
      var related = e.relatedTarget ? e.relatedTarget : "unknown";
...
var slider = function slider() {
  ...
  var interval = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4000;
  var width = window.getComputedStyle(document.querySelector(".slider__inner")).width;
  var slides = document.querySelectorAll(".slider__item");
  var slidesField = document.querySelector(".slider__slides");
  ...
  var updateAutoplayInteval = function updateAutoplayInteval() {
...
var smoothScroll = function smoothScroll(trigger) {
  var upBtn = document.querySelector(trigger);
